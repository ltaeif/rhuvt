...
/**
 * Definition class for table etablissement2.
 *
 ...
 * @version $Id$
 *
 * @method Application_Model_Etablissement2_Row createRow(array $data, string $defaultSource = null)
 * @method Application_Model_Etablissement2_Rowset fetchAll(string|array|Zend_Db_Table_Select $where = null, string|array $order = null, int $count = null, int $offset = null)
 * @method Application_Model_Etablissement2_Row fetchRow(string|array|Zend_Db_Table_Select $where = null, string|array $order = null, int $offset = null)
 * @method Application_Model_Etablissement2_Rowset find()
 *
 */
abstract class Application_Model_Etablissement2_DbTable_Abstract extends Zend_Db_Table_Abstract
{
    /**
     * @var string
     */
    protected $_name = 'etablissement2';
  ...
  0 => 'idetablissement',
     ...
     * @var string
     */
    protected $_rowClass = 'Application_Model_Etablissement2_Row';

    /**
     * @var string
     */
    protected $_rowsetClass = 'Application_Model_Etablissement2_Rowset';
